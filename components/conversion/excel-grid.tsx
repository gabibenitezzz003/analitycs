...
export function ExcelGrid({ data }: ExcelGridProps) {
  ...
  return (
    <div className="border border-zinc-800 rounded-lg overflow-hidden bg-[#09090b] shadow-2xl">
      {/* Toolbar */}
      <div className="bg-zinc-900/50 p-2 border-b border-zinc-800 flex gap-2 items-center">
        ...
        <span className="text-xs text-zinc-400 font-mono">b41_interacciones.csv</span>
      </div>
